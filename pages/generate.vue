<template>
  <div v-if="popUp" class="w-full h-full fixed top-0 left-0 flex flex-col p-4 bg-white text-black">
    <div class="h-1/4 flex justify-end" @click="popUp = false">Close</div>
    <div class="h-3/4 flex text-lg">
      <p>Create your activation cards to grow your Emoxy and link them to a friend you think would benefit the most</p>
    </div>
  </div>
  ...
  <div class="h-2/4 flex flex-col items-center justify-center">
    <div v-if="step === -1" class="w-full text-lg">
      ...
      <p class="mt-4">Start by inviting those in your life you want to bond deeper and activate levels of consciousness of your relationship not felt before</p>
      <p class="mt-4">
        Create your activation cards to grow your Emoxy and link them to a friend you think would benefit the most
      </p>
      <p class="mt-4">
        Go through our unique evaluation system and grow together with Emoxys and friends
      </p>
    </div>
    <div v-if="step === 0" class="w-full text-lg">
      <p>A pledge to yourself to fully realize your Emotional Future</p>
      <p class="mt-4">
        Find out now your emotional <strong>Temperament</strong> with a 5 steps
        quiz that analizes your current self
      </p>
      <p class="mt-4">To start, go to a place where you will be undisturbed</p>
      <p class="mt-4">
  ...
  <div class="h-1/4 flex flex-col justify-center items-center">
    ...
    <div v-if="step === 10" class="w-full">
      <p @click="popUp = true" class="underline">Why do I need to share my email?</p>
