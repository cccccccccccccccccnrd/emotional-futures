<template>
  ...
  >
    ...
    <div v-if="step === 2 || step === 3" class="grow flex flex-col justify-between overflow-hidden mt-5">
      ...
      <div v-if="step === 3" class="overflow-scroll">
        ...
        <p class="mt-5">
          To connect with a new Accounterpart, go to your Accounterparts tab and select ”New Connection Invite”. Two options will appear on the screen:
        </p>
        <p class="font-bold mt-5">
          1 Scan QR code
        </p>
        <p class="mt-5">
          If you are both in the same location, just have your Accounterpart scan the code on your device's screen and you will be instantly connected.
        </p>
        <p class="font-bold mt-5">
          2 Invitation Link
        </p>
        <p class="mt-5">
          Once you select this option the share function of your device will appear and direct you to your most-used messaging apps. 
        </p>
        <p class="font-bold mt-5">
    ...
    <div v-if="step === 4 || step === 5 || step === 6" class="grow flex flex-col justify-between overflow-hidden mt-5">
      <div v-if="step === 4" class="overflow-scroll">
        ...
        <p class="mt-5">
          Complete Activations from the eight core emotions to feed your Emoxy's growth. You can only perform one Activation at a time, so both you and your Accounterpart need to commit to the task in play.
        </p>
      </div>
      <div v-if="step === 5" class="overflow-scroll">
        <p class="text-lg font-bold">How To Play an Activation?</p>
        <p class="mt-5">
          To play an Activation and feed your Emoxy you need to create an Activation Card which you:
        </p>
        <p class="mt-5">
        ...
        <p class="mt-5">
          Once your Accounterpart has accepted the invitation, you will be shown your task.
        </p>
        <p class="mt-5">
          After completing the Activation, you shall proceed to Accounting. Here you will take account of your experience and the value of your emotional exchange. Afterwards, your account will be updated with the Blood, Sweat and Tears gained through the Activation.
        </p>
      </div>
      <div v-if="step === 6" class="overflow-scroll">
        ...
        <p class="mt-5">
          After you confirmed an Activation, an invitation link will be provided in two forms:
        </p>
        <p class="font-bold mt-5">
          1 Scan QR Code 
        </p>
        <p class="mt-5">
          If you and your Accounterpart are in the same location, scan the QR code, and you will be instantly connected. You can also share an invite link below.
        </p>
        <p class="font-bold mt-5">
          2 Invitation Link
        </p>
